...
// #endif
		...
		private void SetupConfig()
		{
			...
			EnableChat = SetupSetting(coopHeader, CleanConfigString(LocaleUtils.BEPINEX_ENABLE_CHAT_T.Localized()), true,
			...
			UseHealthNumber = SetupSetting(coopNameplatesHeader, CleanConfigString(LocaleUtils.BEPINEX_USE_PERCENT_T.Localized()), true,
